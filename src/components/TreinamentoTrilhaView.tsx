...
export default function TreinamentoTrilhaView({ onReturn }: { onReturn?: () => void }) {
    ...
    <div className="flex h-full bg-ice overflow-hidden font-sans relative">
          ...
          >
            ...
            <div className="p-5 bg-brand text-white relative border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-[11.5px] font-bold uppercase tracking-tight">Treinamento de Fluxos</h2>
              </div>
              ...
              {lessonList.map((lesson) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <motion.div 
                        layoutId="activeLessonIndicatorTrilhaTreinamento"
      ...
      <div className="flex-1 flex flex-col relative bg-ice w-full lg:w-auto">
            ...
            {!isMobileFocusMode && (
              ...
              >
                <div className="flex items-center justify-between px-5 pt-12 pb-4 relative">
                  <button onClick={onReturn} className="relative z-10 w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-white cursor-pointer hover:bg-white/20 transition-colors backdrop-blur-sm">
        ...
        <div className="hidden lg:flex px-8 py-4 items-center justify-between border-b border-gray-50">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <button onClick={onReturn} className="flex items-center gap-2 bg-brand text-white px-4 py-2 rounded-full hover:bg-brand-dark transition-all shadow-md shadow-brand/20 cursor-pointer group">
            ...
            <nav className="text-[10.5px] flex items-center gap-2 text-gray-400 uppercase tracking-widest font-bold">
              ...
              <span className="text-gray-200">/</span>
              <span className="hover:text-gray-600 cursor-pointer transition-colors">Trilha de Formação Avançada</span>
              <span className="text-gray-200">/</span>
              <span className="text-brand">Treinamento de Fluxos</span>
            </nav>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col relative">
          <div className="max-w-6xl mx-auto w-full flex-1 flex flex-col p-0 lg:p-6 pb-32">
            ...
            <div className="relative lg:mb-4 flex-1 flex items-center justify-center min-h-0 bg-black lg:bg-transparent">
              ...
              {/* Video Placeholder */}
              <div className="w-full max-h-[80vh] lg:max-h-full aspect-video bg-black lg:rounded-xl overflow-hidden shadow-2xl relative flex items-center justify-center">
                <img 
            ...
            {/* Lesson Info */}
            <div className="flex-none px-5 py-4 lg:p-0">
              ...
              <div className="flex items-center border-b border-gray-100 mb-6 overflow-x-auto no-scrollbar w-full">
                {tabs.map((tab) => (
                  ...
                  >
                    ...
                    {activeTab === tab.id && (
                      <motion.div
                        layoutId="activeTabIndicatorTreinamentoTrilha"
      ...
      <AnimatePresence>
        {!isMobileFocusMode && !isMobileDrawerOpen && (
          <motion.button 
            ...
            >
              ...
              <div className="flex-none px-6 py-2 border-b border-gray-100 flex items-center justify-between bg-white relative z-10">
                ...
                <div className="flex-1 flex justify-end">
                  <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest cursor-pointer" onClick={() => setIsMobileDrawerOpen(false)}>
                    Fechar
                  </span>
                </div>
              </div>
              <div className="flex-1 overflow-y-auto custom-scrollbar pb-8">
                {lessonList.map((lesson) => {
                  ...
                  return (
                    <div
                      key={lesson.id}
                      onClick={() => { handleToggleLesson(lesson.id); setIsMobileDrawerOpen(false); }}
                      className={`w-full text-left p-4 border-b border-gray-100/50 transition-all relative group cursor-pointer ${
                        isActive ? 'bg-brand/5' : isCompleted ? 'bg-green-50/50' : 'hover:bg-gray-100/50'
                      }`}
                    >
                      {isActive && (
                        <motion.div 
                          layoutId="activeLessonIndicatorTrilhaTreinamentoMobile"
                          className="absolute left-0 top-0 bottom-0 w-1 bg-brand" 
                        />
                      )}
                      ...
                      <div className="flex items-start gap-3">
                        <button 
                          onClick={(e) => { e.stopPropagation(); handleToggleComplete(e, lesson.id); }}
                          className={`mt-1 flex-none transition-all hover:scale-110 active:scale-90 cursor-pointer ${
                            isCompleted ? 'text-green-500' : isActive ? 'text-brand' : 'text-gray-400'
                          }`}
                        >
